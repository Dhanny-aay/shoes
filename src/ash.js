...
const Ash = () => {
    return ( 
        <motion.div 
            ...
            className=" w-full bg-[#727774] flex relative items-center px-[20%]">
                <div className=" flex flex-col md:justify-between justify-center items-center w-full">
                    <motion.img 
                    initial={{rotate:40}}
                    animate={{rotate:0}}
                    transition={{ delay:1.2, duration:0.4}}
                    src={ ash } className=' w-[170px] h-[85px] md:w-[300px] md:h-[150px] md:fixed left-[10%]' alt="" />
                    <motion.div 
                    initial={{opacity:0}}
                    animate={{opacity:1}}
                    ...
                    className=" flex flex-col text-left md:ml-auto absolute bottom-10 left-10 md:static">
                        <p className=" font-bold font-Tilt text-2xl tracking-wider">Arch Ash</p>
            ...
            <div className=" w-full flex md:flex-row flex-col p-5 md:p-0">
                ...
                <div className="md:w-[40%] w-full flex flex-col pt-7">
                    <div className=" space-y-6">
                        <p className=" text-[#727774] text-left tracking-wide font-Kanit font-semibold">$60</p>
                        <span className=" flex flex-row space-x-5">
                            <button className=" border border-[#727774] text-[#727774] px-[20px] py-[5px] font-Labrada text-base font-medium">Store</button>
                            <button className=" bg-[#727774] text-white px-[20px] py-[5px] font-Labrada text-base font-medium">View Collection</button>
                        </span>
                    </div>
                    <div className="mt-8 w-full px-6 pt-5 pb-8 bg-[#727774]">
                        <p className=" font-Labrada text-[#fff] text-lg font-bold">About me</p>
                        <p className="font-Labrada mt-5 text-[#fff] text-base font-normal">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin eget nulla justo. Curabitur massa leo, bibendum sed dui in, dignissim gravida mi. Curabitur et maximus sapien, vel faucibus purus. Sed convallis condimentum volutpat. Aliquam rutrum elit eu egestas porttitor. Praesent scelerisque mollis elementum. Nam at nibh leo. Aliquam id blandit mauris, sit amet tincidunt ex. Nam et nunc ac nulla sollicitudin hendrerit. Maecenas nec pharetra.</p>
                        <div className=" mt-6 flex flex-row justify-between font-Labrada text-[#fff]">
                            <div className=" flex flex-col space-y-4">
                                <span className=" ">
                                    <p className=" font-bold text-base">Color</p>
                                    <p className=" font-nomal text-sm">Blue/Ash</p>
                                </span>
                                <span className=" ">
