...
const Gold = () => {
    return ( 
        <motion.div 
            ...
            className=" w-full bg-[#c4b17f] flex relative items-center px-[20%]">
                <div className=" flex justify-between items-center w-full">
                    <motion.img 
                    initial={{rotate:40}}
                    animate={{rotate:0}}
                    transition={{ delay:1.2, duration:0.4}}
                    src={ gold } className=' w-[170px] h-[85px] md:w-[300px] md:h-[150px] md:fixed left-[10%]' alt="" />
                    <motion.div 
                    initial={{opacity:0}}
                    animate={{opacity:1}}
